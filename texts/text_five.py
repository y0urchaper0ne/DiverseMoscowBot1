...
electro_beginning = f'Мы начали прогулку с самого старого в рамках маршрута театра, ' \
        ...
        f'сцен в России! О нем я даже слышал у себя в Paris.'

electro_building_text = f'Как здание Электротеатра прошло путь от доходного дома с борделем' \
     f' до современного театра — вся информация в статье по ссылке ⬇️'

electro_history_text = f'От оперы до артхауса: как студия Станиславcкого стала Электротеатром?' \
     f' Читайте историю в статье по ссылке ⬇️'
